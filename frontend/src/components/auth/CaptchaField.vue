...
.captcha-field__label { color: var(--theme-text); font-size: 13px; font-weight: 600; }
.captcha-field__row { display: flex; gap: 10px; }
.captcha-field input { min-width: 0; flex: 1; height: 46px; box-sizing: border-box; border: 1px solid var(--theme-border); border-radius: 8px; padding: 0 14px; outline: none; background: var(--theme-surface); color: var(--theme-text); font: inherit; letter-spacing: .12em; }
.captcha-field input:focus { border-color: var(--theme-accent); box-shadow: 0 0 0 3px color-mix(in srgb, var(--theme-accent) 18%, transparent); }
.captcha-field__image { display: grid; place-items: center; width: 128px; min-width: 96px; height: 46px; overflow: hidden; border: 1px solid var(--theme-border); border-radius: 8px; padding: 0; background: var(--theme-surface); color: var(--theme-accent); cursor: pointer; font-size: 11px; }
...
.captcha-field__error { color: var(--theme-danger); font-size: 12px; }
</style>
