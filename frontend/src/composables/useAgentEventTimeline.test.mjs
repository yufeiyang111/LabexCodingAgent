...
test('routes compaction/context status and accumulates token usage', () => {
  ...
  const usageEvent = { type: 'TOKEN_USAGE', eventId: 'usage-1', data: { taskId: 10, executionEpoch: 2, iteration: 1, promptTokens: 10, completionTokens: 5, totalTokens: 15, cachedTokens: 4, cacheWriteTokens: 6, cacheStatus: 'hit', cacheTelemetryReported: true } }
  ...
  assert.deepEqual(state.tokenUsage.value, { ...createTokenUsageState(), promptTokens: 10, completionTokens: 5, totalTokens: 15, callCount: 1, cachedTokens: 4, cacheWriteTokens: 6, cacheStatus: 'hit', cacheTelemetryReported: true, cacheTelemetryCallCount: 1, cacheReportedPromptTokens: 10, cacheHitRate: 40, taskId: 10, executionEpoch: 2, seenUsageEventKeys: ['usage-1', 'task:10:epoch:2:iteration:1'] })
