...
CREATE TABLE IF NOT EXISTS t_tutorial_document (
...
CREATE TABLE IF NOT EXISTS t_agent_model_config (
    ...
    request_options_json LONGTEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS t_agent_conversation (
    ...
    runtime_profile VARCHAR(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS t_ops_alert_rule (
...
CREATE TABLE IF NOT EXISTS t_ops_alert_notification (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS t_ops_event (
    event_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    event_type VARCHAR(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS t_ops_incident (
...
CREATE TABLE IF NOT EXISTS t_ops_operation (
...
CREATE TABLE IF NOT EXISTS t_ops_audit_log (
